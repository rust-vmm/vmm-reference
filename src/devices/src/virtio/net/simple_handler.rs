...
// 65562 or 1526 bytes."
// For transmission, the standard states "The header and packet are added as one output descriptor
// to the transmitq, and the device is notified of the new entry". We assume the TX frame will
// not exceed this size either.
// TODO: If the driver places a single descriptor on TX, we can simplify the logic (which right
// now assumes multiple descriptors can be present).
